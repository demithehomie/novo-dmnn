...
import { SmsBody } from 'src/app/interfaces/smsbody';
...
cadastro(): void{
  ...
  this.usuarioService.create(data).subscribe({next: (res) => 
  {
    ...
    this.twofaService.sendSMS(this.usuario.phoneNumber);
  ...
  //  phone: this.cliente.phone,
    phoneNumber: this.cliente.phoneNumber, 
...
formatarTelefone() {
  ...
  if (this.cliente !== null && this.cliente.phoneNumber !== null) {
    this.cliente.phoneNumber = this.cliente.phoneNumber.replace(telefoneRegex, '($1) $2-$3');
  }
}
